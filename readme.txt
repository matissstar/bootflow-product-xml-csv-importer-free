...
= 1.0.0 =
* Improved: Product Name field is now optional in field mapping
* Improved: Automatic fallback to SKU or "Product" when Product Name is not mapped or empty
* Improved: Better handling of products with auto-generated SKUs as product names
