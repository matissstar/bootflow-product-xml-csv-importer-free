                                ...
                                <div class="pricing-engine-container" style="padding: 20px;">
                                    ...
                                    <div id="pricing-engine-settings" style="display: none;">
                                        ...
                                        <div style="margin-bottom: 20px; padding: 20px; background: #fff; border: 2px solid #e0e0e0; border-radius: 8px;">
                                            ...
                                            <p class="description" style="margin-top: 8px; color: #666;"><?php esc_html_e('Select the XML field that contains the supplier/wholesale price (used for Regular Price)', 'bootflow-product-xml-csv-importer'); ?></p>

                                            <label style="font-weight: 600; display: block; margin: 18px 0 12px; color: #333; font-size: 14px;">
                                            ...
                                            <select id="pricing_engine_sale_price" name="pricing_engine_sale_price" class="bfpi-field-select" style="width: 100%; max-width: 400px; padding: 10px;">
                                                <option value=""><?php esc_html_e('-- None (do not calculate Sale Price) --', 'bootflow-product-xml-csv-importer'); ?></option>
                                            </select>
                                            <p class="description" style="margin-top: 8px; color: #666;"><?php esc_html_e('Optional. If set, Sale Price is calculated using rules whose "Apply to" includes Sale.', 'bootflow-product-xml-csv-importer'); ?></p>
                                        </div>
                                            ...
                                            <div id="pricing-rules-list">
                                                <div class="pricing-rule-row pricing-rule-default" data-rule-id="default" style="padding: 20px; background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); border: 2px solid #4caf50; border-radius: 8px; margin-bottom: 15px;">
                                                    ...
                                                    <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: center;">
                                                        ...
                                                        <div>
                                                            <label style="font-size: 12px; color: #558b2f; display: block; margin-bottom: 4px;"><?php esc_html_e('Apply to', 'bootflow-product-xml-csv-importer'); ?></label>
                                                            <select name="pricing_rule[default][apply_to]" style="padding: 8px; border: 2px solid #81c784; border-radius: 4px; min-width: 140px;">
                                                                <option value="both"><?php esc_html_e('Both (Regular + Sale)', 'bootflow-product-xml-csv-importer'); ?></option>
                                            ...
                                            <template id="pricing-rule-template">
                                                <div class="pricing-rule-row pricing-rule-conditional" data-rule-id="" style="padding: 20px; background: #fff; border: 2px solid #e0e0e0; border-radius: 8px; margin-bottom: 15px; transition: all 0.2s;">
                                                    ...
                                                    <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-end;">
                                                        ...
                                                        <div>
                                                            <label style="font-size: 12px; color: #666; display: block; margin-bottom: 4px;"><?php esc_html_e('Apply to', 'bootflow-product-xml-csv-importer'); ?></label>
                                                            <select name="pricing_rule[{id}][apply_to]" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px; min-width: 140px;">
                                                                <option value="both"><?php esc_html_e('Both (Regular + Sale)', 'bootflow-product-xml-csv-importer'); ?></option>
                                                                <option value="regular"><?php esc_html_e('Regular only', 'bootflow-product-xml-csv-importer'); ?></option>
                                                                <option value="sale"><?php esc_html_e('Sale only', 'bootflow-product-xml-csv-importer'); ?></option>
                                                            </select>
